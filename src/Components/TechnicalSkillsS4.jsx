  ...
  <div className='TechnicalSkillsS4 relative lg:px-20 px-10 pt-[50rem] lg:pt-0'>
   ...
   <div className='skill-section-one'>
    ...
    <div className="skills-catagories  grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4 items-center ">
     <div className="skills-icons grid grid-cols-3 ">
      {
       skillsIcons.slice(0, 9).map((frontEnd, index) => {
        return (
   ...
   <div className="skill-section-two pt-20">
    ...
    <div className="skills-catagories  grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4 items-center">
     ...
     <div className="skills-icons grid grid-cols-3 ">
      {
       skillsIcons.slice(9, 15).map((backEnd, index) => {
        return (
         <div key={index} className=' skills-list flex flex-col relative  items-center justify-center p-4'>
          <div className="stack-shadow absolute"></div>
    ...
    <img className='absolute sectionIndicator2 lg:w-[24%] lg:h-[20%] md:w-[34%] md:h-[22%]  lg:bottom-[22%] md:bottom-[12%] lg:left-[50%] md:left-[50%]  lg:block md:block hidden' src={sectionIndicator2} alt="" />
   </div>
   ...
   <div className="skill-section-three pt-20 ">
    ...
    <div className="skills-catagories  grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4 items-center">
     <div className="skills-icons grid grid-cols-3 ">
      {
       skillsIcons.slice(15, 24).map((techTools, index) => {
        return (
         <div key={index} className=' skills-list flex flex-col relative  items-center justify-center p-4'>
          <div className="stack-shadow absolute"></div>
