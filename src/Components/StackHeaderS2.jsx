...
const StackHeaderS2 = () => {
  return (
    <>
      <div className="stack-header flex justify-center absolute bottom-[40px] ">
        ...
        <div className="stack-list absolute z-30 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 rounded-2xl justify-items-center items-center content-center drop-shadow-xl">
