		...
		<>
			...
			<div class="container bg-gray-200 mx-auto w-full h-full">
				<div class="relative wrap overflow-hidden p-10 h-full">
					<div class="border-2-2 absolute left-[50%] border-opacity-20 border-gray-700 h-full border" ></div>
					...
					<div class="mb-8 flex justify-between items-center w-full right-timeline">
						...
						<div class="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
							<h3 class=" font-bold text-gray-800 text-xl">Intern Front End Developer</h3>
							<h6 class="mb-3 font-bold text-gray-800 text-sm ]">Edufied
								<span> | Jan 23 to Jun 23</span>
							</h6>
							<div class="text-sm font-medium leading-snug tracking-wide text-white text-opacity-100 text-justify">
					...
					<div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
						...
						<div class="order-1 bg-red-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
							<h3 class=" font-bold text-gray-800 text-xl">Front End Developer</h3>
							<h6 class="mb-3 font-bold text-gray-800 text-sm ]">Edufied
					...
					<div class="mb-8 flex justify-between items-center w-full right-timeline">
						...
						<div class="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
						<h3 class=" font-bold text-gray-800 text-xl">VOLUNTEER | Team and Scrum Master </h3>
							<h6 class="mb-3 font-bold text-gray-800 text-sm ]">Programming Hero 
					...
					<div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
						...
						<div class="order-1 bg-red-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
						<h3 class=" font-bold text-gray-800 text-xl">WordPress Developer </h3>
							<h6 class="mb-3 font-bold text-gray-800 text-sm ]"> Freelance
								<span> | Sep-20 to Dec-21</span>
							</h6>

							<div class="text-sm font-medium leading-snug tracking-wide text-white text-opacity-100">
