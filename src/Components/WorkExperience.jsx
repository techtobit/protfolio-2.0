	...
	return (
		<>
			...
			<div className="container bg-gray-200 mx-auto w-full h-full">
				...
				<h4 className='py-2 px-4 bg-blue-100 text-white-200 w-fit  absolute lg:left-[45.5%] font-bold'>Experience</h4>
					...
					<div className="lg:mb-8 my-8 flex lg:justify-between items-center w-full right-timeline">
						...
						<div className="flex z-40 bg-blue-100 items-center lg:order-1 shadow-xl lg:static absolute lg:left-0 left-[.5%] w-8 h-8 rounded-full">
							<h1 className="mx-auto font-semibold text-lg text-white-200">1</h1>
						</div>
						<div className="order-1 bg-gray-400 rounded-lg shadow-xl lg:w-5/12 px-6 py-4 lg:ml-0 ml-2">
							...
							<div className="text-sm font-medium leading-snug tracking-wide text-white text-opacity-100 text-justify">
								<li>Converted <b>100+ Figma to frontend web </b>  and ensure seamless integration of UI/UX, Pixel-perfect design.</li>
								<li><b>I reviewed and merged 200+ developers' PRs</b>, provided feedback, assisted in resolving issues, ensured quality.</li>
...
{/* 					<div className="mb-8 flex justify-between items-center w-full right-timeline"> */}
						...
						<h3 className=" font-bold text-gray-800 text-xl">VOLUNTEER | Team and Scrum Master </h3>
							...
							<div className="text-sm font-medium leading-snug tracking-wide text-white text-opacity-100 text-justify">
								<li> <b>Agile Facilitation: </b> Lead Agile methodologies, ensuring effective Scrum ceremonies and team collaboration.</li>
								<li> <b>Mentorship:</b> Allocate tasks and fix issues to maintain a balanced workflow and meet deadlines.</li>
								<li><b>Resource Management:</b> Repositories and website’s related to front end.</li>
								<li><b>Stakeholder Liaison:</b> Communicate, gather feedback, and manage expectations between teams.</li>
							</div>
						</div>
					</div>
...
{/* 					<div className="lg:mb-8 mb-20 flex justify-between lg:flex-row-reverse flex-row items-center w-full left-timeline"> */}
					...
					<h4 className='py-2 px-4 bg-blue-100 text-white-200 w-fit  absolute lg:left-[45.5%] bottom-0 font-bold'>Certificate</h4>
				</div>
			</div>
