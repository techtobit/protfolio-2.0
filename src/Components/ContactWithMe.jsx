        ...
        <div className="admin-info h-[100%]">
          <div className="admin-card  relative z-0 rounded-md bg-blue-100 lg:w-[60%] md:w-[100%] w-[100%] h-[100%]">
            ...
            <div className="contact-info pl-5 pt-4">
              ...
              <a href="https://api.whatsapp.com/send?phone=8801886627127" className=""phone-numbe  flex gap-4 pt-4 items-center text-white-200  "><FaWhatsappSquare /> <span>WhatsApp</span></a>
