...
const FAQs = () => {
  return (
    <div className="faqs-section lg:mt-[10%] mt-[20%]">
      ...
      <div className='l grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 items-center lg:justify-items-start justify-items-center lg:px-20 px-4 lg:gap-20 gap-10'>
