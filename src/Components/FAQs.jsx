...
const FAQs = () => {
 return (
  <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 items-center lg:px-20 px-4 gap-10'>
   ...
   <div className="QNAs">
    <details class="w-full bg-white border-[0.5px] border-blue-50 cursor-pointer mb-3">
